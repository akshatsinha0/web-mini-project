...
export default function Contact() {
  ...
  const handleSubmit=(e)=>{
    emailjs.send('service_7vftg3f', 'template_b142zv5', {to_name: 'Coding Club VIT Vellore',message: values.message, from_name: values.name, reply_to: values.email,},'Mn912QQNe57pFwJEa')
  ...
  <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      <iframe width="100%" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.7246911885513!2d79.15389361482133!3d12.969428990855727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bad47075009a957%3A0xabccc4eff0106092!2sVellore%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1670850183398!5m2!1sen!2sin" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no"></iframe>
      <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        <div class="lg:w-1/2 px-6">
          <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
          <p class="mt-1">VIT Vellore, Katpadi, Vellore, Tamil Nadu 632014</p>
        </div>
        <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
          <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
          <a class="text-indigo-500 leading-relaxed">codingclub@vit.ac.in</a>
    ...
    {/* <Contributors owner={"coding-club-vit-vellore"} repo={"ClubWebsite"} />; */}
